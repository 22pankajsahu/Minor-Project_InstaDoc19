...
<body>
    ...
    <!-- <main> -->
		...
		<?php
			...
			$ds_select = "select ds_id,ds_name,ds_image,ds_doctor from disease";
            ...
            <div class="col mt-3">
                <div class="card">
                    ...
                    <div class="card-desc p-2 mt-3">
                        ...
                        <p><a href="doctor-description/doctor-description.php?doc_id=<?php echo $ds_row['ds_doctor'];?>"><span class="btn btn-success p-1 text-light rounded find-doctors">Find Doctors</p></a>
                        
                        <a href="diseases/diseases-description.php?ds_id=<?php echo $ds_row['ds_id'];?>">    
                        <button id="view" value="44" class="btn btn-warning text-dark pl-3 pr-3 rounded add-view"> Read
                            Symptoms </button>  </a>
                    </div>
                </div>
            </div>
