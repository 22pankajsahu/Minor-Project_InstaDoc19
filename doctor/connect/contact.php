...
<?php
	...
	//updating status for connection
	$updatecr = "update chatrequest set cr_status=$cr_from_id, cr_video_link='none', cr_passcode='none' where cr_from_id=$cr_from_id";
	if(mysqli_query($conn, $updatecr)){
		$userselect = "select firstname from user where uid=$cr_from_id";
...
?>
    <div class="container-fluid h-100">
                ...
                <div class="card">
                    <div class="card-header msg_head">
                        <div class="d-flex bd-highlight">
                            <div class="user_info">
                                <span>Patient: <?php echo $userrow['firstname'];?></span>
                            </div>
                            <div class="video_cam">
                                <span><a href="call/index.php?cr_from_id=<?php echo $cr_from_id;?>">Start <i class="fa fa-video-camera"></i></a></span>
		...
		<div class="row pb-5 justify-content-center">
			<a href="../index.php"><button class="btn btn-danger">End Chat</button></a>
		</div>
        ...
        $(document).ready(function () {
			...
			setInterval(function (){
				...
				$.ajax({
					...
					url:"messages.php",
					data:{
						cr_from_id:<?php echo $cr_from_id;?>,
					},
					success: function(response){
						document.getElementById("mychatbox").innerHTML=response;
					}
				});
			},1000);
