        ...
        <section class="main-content">
            <div class="container">
				...
				<?php
					...
					$doc_select = "select doc_id,firstname,lastname,gender,specialist,experience,qualification,docimage from user inner join doctor on uid=user_id ";
                        ...
                        <div class="place-card">
                            ...
                            <div class="place-card__content">
                                ...
                                <a href="doctor-description/doctor-description.php?doc_id=<?php echo $doc_row['doc_id'];?>" class="btn btn-sm btn-primary">Viw
                                    Profile</a> <a href="../contact.php" class="btn btn-sm btn-success">Connect</a>
                            </div>
                        </div>
                    </div>
					<?php
