    ...
    <div class="container">
        <div class="description pt-3">
            <div class="description-img">
                <img class="img-thumbnail float-right" src="../../patient/<?php echo $at_row['at_image'];?>" alt="Description Image">
            </div>
        </div>
        <div class="p-5 pt-3 col-sm-6 description-desc">
			...
			<br/>
			<a class="btn btn-warning" href="deletearticle.php?at_id=<?php echo $at_row['at_id'];?>"> Delete</a>
        </div>
    </div>
	<?php
	}
