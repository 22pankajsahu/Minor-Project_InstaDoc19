    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-7">
				...
				<h2 class="text-center registration-title">
					<?php
						...
						if(isset($_POST["upload"])){
							...
							if(empty($at_title) || empty($at_short_info) || empty($at_info)){
								echo "All fields are required.";
							}
							else{
								$articleupdate = "update article set at_title='$at_title',at_short_info='$at_short_info',at_info='$at_info' where at_id=$at_id and user_id=$user_id";
								if(mysqli_query($conn, $articleupdate)){
				...
				<?php
					$article_select = "select at_id,at_title,at_short_info,at_info from article where at_id=$at_id and user_id=$user_id";
					$article_result = mysqli_query($conn, $article_select);
				...
				?>
                    <form class="form form-registration" action="" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" class="form-control" value="<?php echo $article_row['at_title'];?>" id="at_title" name="at_title" placeholder="Title" required>
						
						<label for="label">Short Content(2-3 lines only)</label>
                        <input type="text" class="form-control" value="<?php echo $article_row['at_short_info'];?>" id="at_short_info" name="at_short_info" placeholder="Short content" required>

                        <label for="content">Content</label>
                        <textarea rows="3" class="form-control" id="at_info" name="at_info" placeholder="Content" required><?php echo $article_row['at_info'];?></textarea>
						
						<input type="hidden" class="form-control" value="<?php echo $article_row['at_id'];?>" id="at_id" name="at_id" required>
