...
<body>
<?php
	$image_select = "select ds_image from disesase where ds_doctor=$user_id";
	$image_result = mysqli_query($conn, $image_select);
	if(mysqli_num_rows($image_result)>=1){
		$image_row = mysqli_fetch_assoc($image_result);
		$delete = "../../patient/".$image_row['ds_image'];
		unlink($delete);
	}
	$ds_delete = "delete from disease where ds_id=$ds_id and ds_doctor=$user_id";
	if(mysqli_query($conn, $ds_delete)){
?>
    <div class="container">
