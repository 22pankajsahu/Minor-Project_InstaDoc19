...
<head>
	...
	<title>Doctor Panel - InstaDoc19</title>
    <!--=============== FONTAWESOME ===============-->
    ...
    <section class="services">
        ...
        <div class="box-container">
			...
			<?php
				...
				$at_select = "select at_id,at_title,at_short_info,at_image from article where user_id=$user_id";
			...
			?>
            <div class="box">
                <img src="../patient/<?php echo $at_row['at_image'];?>">
                <font><?php echo $at_row['at_title'];?></font>
                <p>
					<?php echo $at_row['at_short_info'];?>
                </p>
                <!--btn--------->
                <span><a href="article/articles.php?at_id=<?php echo $at_row['at_id'];?>"> View</a> | <a href="article/editarticle.php?at_id=<?php echo $at_row['at_id'];?>"> Edit </a></span>
            </div>
			<?php
					}
				}
	...
	<script>
        $(document).ready(function () {
			...
			setInterval(function (){
				...
				$.ajax({
					method:"post",
					url:"connect/crequest.php",
					data:{
						cr_to_id:<?php echo $user_id;?>,
					},
					success: function(response){
						document.getElementById("cr").innerHTML=response;
					}
				});
			},1000);
        });
